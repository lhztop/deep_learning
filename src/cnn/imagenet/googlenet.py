...
def create_googlenet(width, height, weights_path=None):
    ...
    inception_4b_3x3 = Convolution2D( (width,height), 3, 3, border_mode='same', activation='relu', name='inception_4b/3x3', W_regularizer=l2(0.0002))(inception_4b_3x3_reduce)
